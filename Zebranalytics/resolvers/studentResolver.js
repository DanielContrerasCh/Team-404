...
let StudentResolver = class StudentResolver {
    ...
    createStudent(name, email, last_name, favorite_color, birth_date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(name, email, last_name, favorite_color, birth_date);
                return {
                    name, // Return the inserted student object
                    email,
                    last_name,
                    favorite_color,
                    birth_date
                ...
                console.error(err);
                throw new Error('Failed to create student'); // Throw error instead of returning null
            }
        });
    }
...
__decorate([
    ...
    __param(3, (0, type_graphql_1.Arg)("favorite_color")),
    __param(4, (0, type_graphql_1.Arg)("birth_date")),
    __metadata("design:type", Function),
